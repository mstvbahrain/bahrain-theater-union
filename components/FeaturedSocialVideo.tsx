  ...
  return (
    <section className="bg-cream px-5 py-20">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.85fr_1.15fr]">
        <div>
          <p className="text-sm font-semibold text-gold">تابعونا</p>
          <h2 className="mt-3 font-heading text-4xl text-black md:text-5xl">ابقوا على تواصل</h2>
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-1">
            <a href={siteConfig.youtubeUrl} className="group rounded-3xl bg-gradient-to-br from-red-700 to-black p-7 text-white shadow-luxury transition hover:-translate-y-1">
              ...
              <p className="mt-2 text-white/75">شاهدوا أحدث مقاطعنا</p>
            </a>
            <a href={siteConfig.instagramUrl} className="group rounded-3xl bg-gradient-to-br from-pink-700 via-purple-800 to-amber-600 p-7 text-white shadow-luxury transition hover:-translate-y-1">
              ...
              <p className="mt-2 text-white/75">تابعوا آخر أخبارنا</p>
            </a>
          </div>
        </div>
        <div>
          <p className="text-sm font-semibold text-gold">فيديو مميز من يوتيوب</p>
          <h2 className="mt-3 font-heading text-4xl text-black md:text-5xl">أحدث المشاركات</h2>
          <div className="gold-line" />
          <div className="video-frame mt-10 aspect-video overflow-hidden rounded-[2rem] bg-black p-3 shadow-luxury">
            <iframe src={siteConfig.featuredVideoEmbed} title="فيديو يوتيوب مميز" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
          </div>
        </div>
      </div>
    </section>
